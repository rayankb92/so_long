...
/*   Updated: 2022/11/25 18:04:05 by rferradi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ZERO "./img/0.xpm"
# define UN "./img/1.xpm"
# define DEUX "./img/2.xpm"
# define TROIS "./img/3.xpm"
# define QUATRE "./img/4.xpm"
# define CINQ "./img/5.xpm"
# define SIX "./img/6.xpm"
# define SEPT "./img/7.xpm"
# define HUIT "./img/8.xpm"
# define NEUF "./img/9.xpm"
# define GI "./img/gigi.xpm"
# define GID "./img/giroudd.xpm"
...
void			display_score(t_data *img, t_position *map, int nb, int i);
